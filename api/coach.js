...
module.exports = async function handler(req, res){
  ...
  if(action === 'athletes'){
    const ath = await sb(`/rest/v1/profiles?coach_id=eq.${user.id}&select=id,email,first_name,last_name,race_name,race_date,race_divisions,training_phase,track_ids`, token, {method:'GET'});
